...
package com.newversion.tabstrip;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabPadding = 10;// 24
	private int dividerWidth = 1;

	private int tabTextSize = 12;
	private int tabTextColor = 0xFF666666;
	private int selectedTabTextColor = 0xFF666666;
	private int selectedTabTextBackground = 0xFF666666;
	...
	public void setSelectedTextBackground(int background) {
		this.selectedTabTextBackground = background;
		updateTabStyles();
	}

	public void setSelectedTextBackgroundResource(int resId) {
		this.selectedTabTextBackground = getResources().getColor(resId);
		updateTabStyles();
